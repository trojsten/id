...
GOOGLE_TFA_MIN_ACCOUNT_AGE = env.timedelta("GOOGLE_TFA_MIN_ACCOUNT_AGE", default=timedelta(days=5))
GOOGLE_TFA_MAX_ACCOUNT_AGE = env.timedelta("GOOGLE_TFA_MAX_ACCOUNT_AGE", default=timedelta(days=14))
